...
class ReminderManager extends InvitationManager
{
    ...
    public function sendReminders($sub)
    {
        ...
        foreach ($candidates as $candidate) {
            ...
            $send_today = $this->checkIfDateValid($candidate[$this->portalConfig->startDateField], $this->portalConfig->reminderValidDayArray);

            if ($send_today == null) {
                //today is not a reminder day for this candidate
                continue;
